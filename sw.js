const CACHE='comoara-v29-admin-participanti';
const ASSETS=['./','./index.html','./app.js?v=29','./account.js?v=29','./app-shell.css?v=6','./app-shell.js?v=6','./manifest.json','./favicon.png','./apple-touch-icon.png','./icon-192.png','./icon-512.png','./logo-comoara-v14-sync-bife','./iordan-sampras-final.png','./developer-comoara-ascunsa.jpeg'];
